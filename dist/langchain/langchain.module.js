...
const langchain_controller_1 = require("./langchain.controller");
...
exports.LangchainModule = LangchainModule = __decorate([
    (0, common_1.Module)({
        controllers: [langchain_controller_1.LangchainController],
        providers: [langchain_service_1.LangchainService],
    })
], LangchainModule);
